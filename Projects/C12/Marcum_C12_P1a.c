...
//	Name: noisreV tnI - esreveR ni daeR t'naC T
//  Purpose: Reverses a sentence - Int Version
//  Author: James Marcum
...
//void print_mess_reverse_point(char mess[],char *final_char); - Not included in this version
...
int message_len = read_mess(message, MAX); //call read_mess to get the message
	...
	//call print_mess_reverse_int
	print_mess_reverse_int(message, message_len);
	//call print_mess_reverse_point - NOT INCLUDED
