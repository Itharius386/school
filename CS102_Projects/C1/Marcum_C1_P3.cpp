...
int main()
{
    //sphere instance, largest sphere instance
    Sphere sphere1, l_sphere;
    //input
    double inp;
    //sphere type
...
//take sphere type and ask for the numerical value
    switch (s_type)
    {
        case 'r':   cout << "What is the radius of the sphere? ";
                    in_check(&inp);
                    sphere1.setRadius(inp);
                    break;
        case 'd':   cout << "What is the diameter of sphere? ";
                    in_check(&inp);
                    sphere1.setDiameter(inp);
                    break;
